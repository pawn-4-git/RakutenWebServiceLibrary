 ...
 * @author Pawn
 */
public class RakutenIchibaBookGameResultEntity {
    ...
    private List<RakutenIchibaBookGameResultItemEntity> items=new ArrayList<>();
     ...
     * @return the items
     */
    public List<RakutenIchibaBookGameResultItemEntity> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<RakutenIchibaBookGameResultItemEntity> items) {
        this.items = items;
    }
