 ...
 * @author Pawn
 */
public class RakutenIchibaBooksBookResultEntity {
    ...
    private List<RakutenIchibaBooksBookResultItemEntity> items=new ArrayList<>();
     ...
     * @return the items
     */
    public List<RakutenIchibaBooksBookResultItemEntity> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<RakutenIchibaBooksBookResultItemEntity> items) {
        this.items = items;
    }
