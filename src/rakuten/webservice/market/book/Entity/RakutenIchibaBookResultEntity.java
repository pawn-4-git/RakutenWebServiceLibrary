 ...
 * @author Pawn
 */
public class RakutenIchibaBookResultEntity {
    ...
    private List<RakutenIchibaBookResultItemEntity> items=new ArrayList<>();
     ...
     * @return the items
     */
    public List<RakutenIchibaBookResultItemEntity> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<RakutenIchibaBookResultItemEntity> items) {
        this.items = items;
    }
