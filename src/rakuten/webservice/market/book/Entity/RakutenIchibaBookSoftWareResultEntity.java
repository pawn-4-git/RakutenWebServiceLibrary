 ...
 * @author Pawn
 */
public class RakutenIchibaBookSoftWareResultEntity {
    ...
    private List<RakutenIchibaBookSoftWareResultItemEntity> items=new ArrayList<>();
     ...
     * @return the items
     */
    public List<RakutenIchibaBookSoftWareResultItemEntity> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<RakutenIchibaBookSoftWareResultItemEntity> items) {
        this.items = items;
    }
