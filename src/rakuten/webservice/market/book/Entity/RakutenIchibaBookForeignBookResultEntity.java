 ...
 * @author Pawn
 */
public class RakutenIchibaBookForeignBookResultEntity {
    ...
    private List<RakutenIchibaBookForeignBookResultItemEntity> items=new ArrayList<>();
     ...
     * @return the items
     */
    public List<RakutenIchibaBookForeignBookResultItemEntity> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<RakutenIchibaBookForeignBookResultItemEntity> items) {
        this.items = items;
    }
