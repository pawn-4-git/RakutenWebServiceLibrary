 ...
 * @author Pawn
 */
public class RakutenIchibaItemResultItemEntity {
    ...
    /**
     * @param shopOfTheYearFlag the shopOfTheYearFlag to set
     */
    ...
    /**
     * @param asurakuClosingTime the asurakuClosingTime to set
     */
    ...
    /**
     * @param affiliateRate the affiliateRate to set
     */
    ...
    /**
     * @param pointRateStartTime the pointRateStartTime to set
     */
    ...
    /**
     * @param pointRateEndTime the pointRateEndTime to set
     */
    ...
    /**
     * @param shopAffiliateUrl the shopAffiliateUrl to set
     */
