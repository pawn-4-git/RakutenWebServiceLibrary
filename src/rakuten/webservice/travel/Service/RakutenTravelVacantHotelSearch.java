 ...
 * @author Pawn
 */
public class RakutenTravelVacantHotelSearch extends WebserviceBase{

    /**
     * 楽天商品検索APIの初期化コンストラクタ
     */
    public RakutenTravelVacantHotelSearch(){
        setUrl("https://app.rakuten.co.jp/services/api/Travel/VacantHotelSearch");
        setVersion("20170426");
        setFormat("json");
        setFormatVersion("2");
    }
